...
- `train_vgg_centralized_parallel` : The purpose is the same of the scripts in `train_vgg_centralized`. The only difference is that this scripts launch multiple training of the same model at the same time 
