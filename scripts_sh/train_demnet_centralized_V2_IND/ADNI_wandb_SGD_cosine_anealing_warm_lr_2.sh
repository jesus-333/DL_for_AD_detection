...
#SBATCH --job-name="train_demnet_CENTRALIZED_V2_ADNI_SGD_cosin_aneal_IND"
#SBATCH --nodes=1
...
path_to_save_model="model_weights/demnet_CENT_V2_IND/cosin_anel_SGD_${SLURM_JOB_ID}"
...
for repetition in $(seq 1 $n_repetitions); do
	...
	srun python ./scripts_python/training/update_training_config.py\
		...
		--name_training_run="SGD Cosine Anealing"\
