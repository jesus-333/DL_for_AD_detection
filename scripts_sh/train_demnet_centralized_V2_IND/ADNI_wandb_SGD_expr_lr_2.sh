...
#SBATCH --job-name="train_demnet_CENTRALIZED_V2_ADNI_SGD_expr_IND"
#SBATCH --nodes=1
...
path_to_save_model="model_weights/demnet_CENT_V2_IND/exp_lr_SGD_${SLURM_JOB_ID}"
