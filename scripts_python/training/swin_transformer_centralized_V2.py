...
MRI_train_dataset, _, _      = support_dataset_ADNI.get_dataset_V2(dataset_config, idx_to_use = idx_train, preprocess_functions = model.transforms)
MRI_validation_dataset, _, _ = support_dataset_ADNI.get_dataset_V2(dataset_config, idx_to_use = idx_val, preprocess_functions = model.transforms)
